(() => {
    ...
    (() => {
        ...
        let pickerElement = document.querySelector("[data-datepicker");
        if (pickerElement) {
        ...
        if (chooseBtns.length) chooseBtns.forEach((function(btn) {
            btn.addEventListener("click", (function(event) {
                event.preventDefault();
                toggleActiveClass(btn);
                document.documentElement.classList.add("item-added");
            }));
        }));
        let closeNotification = document.querySelector(".notification-block__close");
